...
chrome.runtime.onInstalled.addListener(function()
{
	...
	{
		"title" : "Transliterate to Sanskrit/Hindi",
		"contexts": ["page"],
		"id": "D"
	});
});
...
chrome.runtime.onMessage.addListener(function(message, sender, sendResponse) 
{
	if(message == "tamMajority")
	{
		...
		chrome.contextMenus.update("D", {"enabled":false});
		chrome.contextMenus.update("D", {"title": "To Sanskrit/Hindi Not Supported(Try Reloading)"});
	}

...
function devToPun(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			else if(unicode == 0x0943)
			{
				answer += String.fromCharCode(0x0A30);
			}
			else if(unicode == 0x0937)
			{
				answer += String.fromCharCode(0x0A36);
			}
			else if((unicode == 0x94E) || (unicode == 0x94F) || (unicode == 0x900) || (unicode == 0x904) || (unicode == 0x90D) || (unicode == 0x90E) || (unicode == 0x911) || (unicode == 0x912) || (unicode == 0x929) || (unicode == 0x931) || (unicode == 0x933) || (unicode == 0x934) || (unicode == 0x93A) || (unicode == 0x93B) || (unicode == 0x949) || (unicode == 0x94A) || (unicode >= 0x0950 && unicode <= 0x095F) || (unicode >= 0x0970 && unicode <= 0x097F) || (unicode == 0x090B) || (unicode == 0x0937) || (unicode == 0x090C) || (unicode == 0x093D) || (unicode >= 0x0943 && unicode <= 0x0946) || (unicode >= 0x0960 && unicode <= 0x0963))
			{
				answer += "";
			}
			else

...
function devToGuj(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			else if((unicode == 0x94E) || (unicode == 0x94F) || (unicode == 0x900) || (unicode == 0x904) || (unicode == 0x90E) || (unicode == 0x912) || (unicode == 0x929) || (unicode == 0x931) || (unicode == 0x933) || (unicode == 0x934) || (unicode == 0x93A) || (unicode == 0x93B) || (unicode == 0x946) || (unicode == 0x94A) || (unicode >= 0x0951 && unicode <= 0x095F) || (unicode >= 0x0971 && unicode <= 0x097F))
			{
				answer += "";
			}
			else

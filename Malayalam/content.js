...
function devToMal(text)
{
	...
	for(var i = 0; i < text.length; i++)
	{
		...
		else
		{
			...
			else if((unicode == 0x94E) || (unicode == 0x94F) || (unicode == 0x900) || (unicode == 0x904) || (unicode == 0x90D) || (unicode == 0x911) || (unicode == 0x93A) || (unicode == 0x93B) || (unicode == 0x945) || (unicode == 0x946) || (unicode == 0x949) || (unicode == 0x94A) || (unicode >= 0x0950 && unicode <= 0x095F) || (unicode >= 0x0970 && unicode <= 0x097F))
			{
				answer += "";
			}
			else
